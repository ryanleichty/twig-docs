---
title: "``html_attr``"
source: "https://github.com/twigphp/Twig/blob/99d95dd6b8b0cc3c2397d15d45a4bb87eff89ddc/doc/functions/html_attr.rst"
upstreamPath: "doc/functions/html_attr.rst"
editLink: true
vue: false
---
:::::: v-pre
...
`html_attr_merge` to combine the arguments:
...
You can use the `html_attr_type` filter to specify a different strategy for
