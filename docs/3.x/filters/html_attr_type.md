---
title: "``html_attr_type``"
source: "https://github.com/twigphp/Twig/blob/ecb310e129f549daa3424f6565520bcc807d16f3/doc/filters/html_attr_type.rst"
upstreamPath: "doc/filters/html_attr_type.rst"
editLink: true
vue: false
---
:::::: v-pre
...
with the `html_attr` function for attributes where
...
This is the default type used when the `html_attr` function encounters an
...
The `style` type is automatically applied by the `html_attr` function when
