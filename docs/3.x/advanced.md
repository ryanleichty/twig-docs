...
source: "https://github.com/twigphp/Twig/blob/ecb310e129f549daa3424f6565520bcc807d16f3/doc/advanced.rst"
upstreamPath: "doc/advanced.rst"
editLink: true
vue: false
---
:::::: v-pre
...
Be warned that `named arguments` passed to a variadic
...
template using it. See `deprecation-notices` for more information.
...
* If your tag does not output anything, but only exists because of a side
  ...
  function instead and call it via the [do](tags/do) tag:
...
> `getOperators()` method. See the [deprecated](deprecated) page for
